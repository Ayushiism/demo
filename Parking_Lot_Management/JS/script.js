...
class UI{
    ...
    static validateInputs(){
        ...
        if(!licensePlateRegex.test(licensePlate)){
            UI.showAlert('License Plate must be like XX YY XX ZZZZ','danger');
            return false;
        }
        return true;
    }
...
//     var btnSubmit = document.getElementById("btnSubmit4");
//     console.log("Ayush");
//     btnSubmit.disabled = true;
//   });
// document.getElementById("btnSubmit4").addEventListener("click", function() {
...
//     var btnSubmit = document.getElementById("btnSubmit5");
//     console.log("Ayush");
//     btnSubmit.disabled = true;
//   });
// document.getElementById("btnSubmit1").addEventListener("click", function() {
